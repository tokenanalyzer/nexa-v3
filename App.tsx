  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#050505', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 28 }}>
        ...
        <Text style={{ color: blink ? '#FF4444' : 'transparent', fontSize: 11, fontFamily: 'monospace' }}>▌</Text>
      </View>
      <View style={{
        ...
        {[
          ...
          <Text key={i} style={{ color: '#ccc', fontSize: 12, lineHeight: 22, fontFamily: 'monospace' }}>{line}</Text>
        ))}
      </View>
      <TouchableOpacity
            ...
            >
              {active && (
                <View style={{
                  ...
                  ...(Platform.OS === 'web'
                    ? { boxShadow: `0 0 8px ${T.accent}` } as object
                    : {}),
                }} />
              )}
