...
const ARCH_STATS = [
  ...
  { label: 'VAULT MODE', value: 'AsyncStorage', icon: '🗄️' },
];
...
const STACK = [
  ...
  { name: 'AsyncStorage', role: 'Local encrypted vault' },
    ...
    <ScrollView style={{ flex: 1, backgroundColor: T.bg }} contentContainerStyle={{ padding: 20, paddingBottom: 100 }}>
      ...
      <View style={{ marginBottom: 28 }}>
        ...
        <View style={{
          ...
          backgroundColor: T.accent + '15', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6,
      ...
      <View style={{ marginBottom: 28 }}>
        ...
        <View style={{
          backgroundColor: T.surface, borderRadius: 16, borderWidth: 1, borderColor: T.card, overflow: 'hidden',
        }}>
          {STACK.map((item, i) => (
      ...
      <TouchableOpacity
        onPress={openGitHub}
        onPressIn={() => setGlowing(true)}
        onPressOut={() => setGlowing(false)}
        style={{
          ...
          alignItems: 'center',
          marginBottom: 28,
          ...(glowing ? glowStyle : cardGlow),
        }}
      >
        <Text style={{ fontSize: 28, marginBottom: 8 }}>🔗</Text>
        <Text style={{ color: T.accent, fontSize: 14, fontWeight: '900', letterSpacing: 2 }}>
          GITHUB VAULT
        </Text>
      ...
      <View style={{ alignItems: 'center', gap: 4 }}>
        ...
        <Text style={{ color: T.card, fontSize: 9, letterSpacing: 1 }}>POWERED BY GEMINI 2.5 FLASH</Text>
      </View>
